...
class GamificationType extends Component {
  ...
  handleChange = name => event => {
    this.state.checked === "" ||
    this.state.checked !== event.currentTarget.value
  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        <Card
          className={
            this.props.select === this.props.name ? classes.select : ""
          }
        >
              ...
              <Grid item xs={12}>
                ...
                >
                  <img
                    ...
                    alt="complex"
                    src={text[this.props.name].image}
                  />
