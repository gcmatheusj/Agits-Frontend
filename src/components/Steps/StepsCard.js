...
import { stepsCard as styles } from './styles';

const StepsCard = (props) => {
  const {
    classes, img, title, description, type, switcher, value,
  } = props;
        ...
        <Grid container style={{ padding: 20 }}>
          <Grid item xs={12}>
            <Grid container direction="row" spacing={16} className={classes.gridCard}>
              ...
              <Switch checked={type} onChange={switcher} value={value} color="primary" />
            </Grid>
          </Grid>
        </Grid>
      </Card>
